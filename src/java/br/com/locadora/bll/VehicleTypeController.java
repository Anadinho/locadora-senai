...
public class VehicleTypeController extends HttpServlet {
        ...
        private static String INSERT_OR_EDIT = "/cadastroVehicleType.jsp";
    private static String EDIT = "/editarVehicleType.jsp";
    private static String LIST_USER = "/listarVehicleType.jsp";
    
    private VehicleTypeDal dal;
    
        public VehicleTypeController() {
        super();
        dal = new VehicleTypeDal();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            if(action.equalsIgnoreCase("listarVehicleType")){
                 forward = LIST_USER;
                 request.setAttribute("vehicleTypes", dal.getAllVehicleType());
        }
