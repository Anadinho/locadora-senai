...
public class AddressController extends HttpServlet {
    ...
    private static String INSERT_OR_EDIT = "/cadastroAddress.jsp";
    private static String EDIT = "/editarAddress.jsp";
    private static String LIST_USER = "/listarAddress.jsp";
    
    private AddressDal dal;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            if(action.equalsIgnoreCase("listarAddress")){
                 forward = LIST_USER;
                 request.setAttribute("addresss", dal.getAllAddress());
        }
