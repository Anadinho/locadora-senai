...
public class ModelController extends HttpServlet {
    ...
    private static String INSERT_OR_EDIT = "/cadastroModel.jsp";
    private static String EDIT = "/editarModel.jsp";
    private static String LIST_USER = "/listarModel.jsp";
    
    private ModelDal dal;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            if(action.equalsIgnoreCase("listarModel")){
                 forward = LIST_USER;
                 request.setAttribute("models", dal.getAllModel());
        }
