...
public class ContactController extends HttpServlet {
    private static String INSERT_OR_EDIT = "/cadastroContact.jsp";
    private static String EDIT = "/editarContact.jsp";
    private static String LIST_USER = "/listarContact.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            if(action.equalsIgnoreCase("listarContact")){
                 forward = LIST_USER;
                 request.setAttribute("contacts", dal.getAllContact());
        }
