<%-- 
    Document   : editar
    Created on : 31/05/2021, 20:16:36
    Author     : Cabral
--%>
    ...
    <body>
        ...
        <nav>
         ...
         <div class="conteudo">
              ...
              <label class="TopdoForm">EDITAR MOTORISTA </label><br>
       ...
       <input type="text" class="campo"     value="cnhValidade" placeholder="Validade" style="width: 75" title="Data de expiração da CNH">
       <input type="text" class="campo"    value="categoriaCnh" placeholder="Categoria" style="width: 60px" title="Categoria da CNH.">
