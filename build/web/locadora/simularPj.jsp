...
<html>
    ...
    <body>
        ...
        <div class="conteudo">
            ...
            <form method="POST" action='RentalController?action=simularRentalPj' name="frmAddRental">
             <!--<label>Veiculos</label>-->
                ...
                <input  type="text" name="initialMileage" value="<c:out value="${simuladoRental.initialMileage}" />" readonly="readonly" class="campo" placeholder="KM atual do veiculo" style="width: 155px" title="Km atual do veiculo."/> <br />
                <!--<input  type="text" value="KM-RODADOS">-->
...
<!--                 <label>Cliente PF</label>
                ...
                <select name="clientPj" class="campo" style="width: 425px" title="Digite o nome da empresa">
